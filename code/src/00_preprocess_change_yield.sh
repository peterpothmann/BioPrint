#!/bin/bash
# length: 50
# sbatch -a 1-1 /gpfs0/home/pothmann/bioprint/03_code/src/00_preprocess_change_yield.sh /data/bioprint/00_data/97_slurm/change-yield-slurm.txt

#SBATCH --job-name=00_preprocess_change_yield
#SBATCH --chdir=/work/pothmann/bioprint
#SBATCH --output=/gpfs1/work/pothmann/bioprint/00_preprocess_change_yield/%x-%A-%a.out
