...
# sbatch -a 1-1 /gpfs0/home/pothmann/bioprint/03_code/src/00_preprocess_seg_lulc.sh /data/bioprint/00_data/97_slurm/lulc-files-in-grid.txt

# length 57

#SBATCH --job-name=00_preprocess_seg_lulc
#SBATCH --chdir=/work/pothmann/bioprint
#SBATCH --output=/gpfs1/work/pothmann/bioprint/00_preprocess_seg_lulc/%x-%A-%a.out
