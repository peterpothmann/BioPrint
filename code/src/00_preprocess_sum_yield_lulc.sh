...
# length: 594
# sbatch -a 1-1 /gpfs0/home/pothmann/bioprint/03_code/src/00_preprocess_sum_yield_lulc.sh /data/bioprint/00_data/97_slurm/preprocess-sum-yield-lulc-slurm.txt


#SBATCH --job-name=00_preprocess_sum_yield_lulc
#SBATCH --chdir=/work/pothmann/bioprint
#SBATCH --output=/gpfs1/work/pothmann/bioprint/00_preprocess_sum_yield_lulc/%x-%A-%a.out
