#!/bin/bash
# length: 250000
# sbatch -a 1-1 /gpfs0/home/pothmann/bioprint/03_code/src/04_iaoh_attribution.sh /data/bioprint/00_data/97_slurm/attribution-slurm.txt

#SBATCH --job-name=04_iaoh_attribution
#SBATCH --chdir=/work/pothmann/bioprint
#SBATCH --output=/gpfs1/work/pothmann/bioprint/04_iaoh_attribution/%x-%A-%a.out
