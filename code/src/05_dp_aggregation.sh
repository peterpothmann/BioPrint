#!/bin/bash
# length: 6844
# sbatch -a 1-1 /gpfs0/home/pothmann/bioprint/03_code/src/05_dp_aggregation.sh /data/bioprint/00_data/97_slurm/dp-aggregation-slurm.txt

#SBATCH --job-name=05_dp_aggregation
#SBATCH --chdir=/work/pothmann/bioprint
#SBATCH --output=/gpfs1/work/pothmann/bioprint/05_dp_aggregation/%x-%A-%a.out
