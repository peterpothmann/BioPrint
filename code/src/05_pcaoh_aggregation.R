## ---------------------------
##
## Script name: 05_pcaoh_aggregation.R
##
...
cli_h1("Inializing pcaoh aggregation")
...
# set up paths
# ------------
outPath <- paste0(workPath, "00_data/04_stage/pcaoh/tif/")


# aggregate csv data
# ------------------

if(!file.exists(paste0(workPath, "00_data/04_stage/pcaoh/pcaoh.csv"))){
  cli_progress_step("Aggregate csv")

  contri <- read_csv(paste0(workPath, "00_data/03_stage/pcaoh/pcaoh.csv"), col_types = "cccccd")
  ...
  write_csv(contri, paste0(workPath, "00_data/04_stage/pcaoh/pcaoh.csv"))
}

# read submit file and get the paths
cli_progress_step("Read submit file")
submit <- read_tsv(paste0(slmPath, "pcaoh-aggregation-setup.txt"), col_types = "cccc") %>%
...
cli_h1("Closing pcaoh aggregation")
