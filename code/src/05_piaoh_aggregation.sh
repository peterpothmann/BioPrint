#!/bin/bash
# length: 32022
# sbatch -a 1-1 /gpfs0/home/pothmann/bioprint/03_code/src/05_piaoh_aggregation.sh /data/bioprint/00_data/97_slurm/piaoh-aggregation-slurm.txt

#SBATCH --job-name=05_piaoh_aggregation
#SBATCH --chdir=/work/pothmann/bioprint
#SBATCH --output=/gpfs1/work/pothmann/bioprint/05_piaoh_aggregation/%x-%A-%a.out
