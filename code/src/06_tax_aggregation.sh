#!/bin/bash
# length: 188
# sbatch -a 1-1 /gpfs0/home/pothmann/bioprint/03_code/src/06_tax_aggregation.sh /data/bioprint/00_data/97_slurm/tax-aggregation-slurm.txt

#SBATCH --job-name=06_tax_aggregation
#SBATCH --chdir=/work/pothmann/bioprint
#SBATCH --output=/gpfs1/work/pothmann/bioprint/06_tax_aggregation/%x-%A-%a.out
